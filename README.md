...
### STEP 2: Click on 'Extruder' then the extruder and extruder nozzle will be displayed.
### STEP 3: Click on 'Material Spool' then material spool will be shown.
### STEP 4: Click on 'Filament' then filament will be added.
### STEP 5: Click on 'Start Process' to begin the process.
### STEP 6: After completing, click on 'Stop Process' to view the product generated using the FDM process.
...
## Result:
### Thus the simulation of the FDM process is completed & prototyping process is studied.
